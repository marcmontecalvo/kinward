...
[[ "${revision_before}" == "001_initial_single_household" ]] || fail "unexpected schema revision before restart"
...
[[ "${example_revision}" == "001_initial_single_household" ]] || fail "copied .env.example did not expose the migrated shared schema"
